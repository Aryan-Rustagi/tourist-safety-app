    ...
    return (
      <div className="google-phone-prompt-card" id="google-phone-prompt-section">
        ...
        <div className="phone-prompt-header">
          ...
          <div>
            <h3 className="phone-prompt-title">Official Contact Setup</h3>
            <p className="phone-prompt-subtitle">Complete your admin security profile</p>
          </div>
        </div>
        ...
        <div className="phone-prompt-safety-note">
          ...
          <span>
            <strong>Official Alert Line:</strong> Your phone number is used for urgent administrative escalation and broadcast alert authorization.
          </span>
        </div>
        ...
        <form onSubmit={handlePhoneSubmit} id="google-phone-form">
          ...
          >
            {isLoading ? (
              ...
              <>
                <span>Save & Continue to Control Room</span>
                <ArrowRight size={16} />
              </>
            )}
          </button>
